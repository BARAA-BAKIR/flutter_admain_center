...
// class HalaqaTypesTab extends StatelessWidget {
//   const HalaqaTypesTab({super.key});

//   @override
//   Widget build(BuildContext context) {
//     return BlocProvider(
//       create: (context) => HalaqaTypesBloc(
//         repository: context.read<SuperAdminRepository>(),
//       )..add(LoadHalaqaTypes()),
//       child: const HalaqaTypesView(),
//     );
//   }
// }

// class HalaqaTypesView extends StatelessWidget {
//   const HalaqaTypesView({super.key});
...
//                   AddHalaqaType(name: controller.text,),
//                 );
...
//               if (controller.text.isNotEmpty) {
//                 context.read<HalaqaTypesBloc>().add(
//                   UpdateHalaqaType(id:type.id,name: controller.text,),
//                 );
//                 Navigator.pop(context);
//               }
//             },
