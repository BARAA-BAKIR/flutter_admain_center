...
//                   return Center(child: Text('فشل تحميل الحلقات: ${state.message}'));
//                 }
...
//                     onRefresh: () async => context.read<HalaqasBloc>().add(const FetchHalaqas()),
...
//                           title: halaqa.name,
//                           subtitle: 'المركز: ${halaqa.centerName} - المسجد: ${halaqa.mosqueName} - النوع: ${halaqa.typeName}',
...
//             MaterialPageRoute(
//               builder: (_) => const AddEditHalaqaScreen(), 
//             ),
//           );
//          },
...
//                   child: AddEditHalaqaScreen(halaqa: halaqa), // ✅ تمرير الحلقة هنا
//                 ),
//               ),
//             );
//              },
...
//                   content: Text('هل أنت متأكد من رغبتك في حذف حلقة "${halaqa.name}"؟'),
//                   actions: [
                ...
                builder: (dialogCtx) => AlertDialog(
                  ...
                  actions: [
                    ...
                    TextButton(
                      child: const Text('حذف', style: TextStyle(color: Colors.red)),
                      onPressed: () {
                        // استخدم context الأصلي لقراءة البلوك
                        context.read<HalaqasBloc>().add(DeleteHalaqa(halaqa.id));
                        Navigator.pop(dialogCtx);
                      },
                    ),
