...
class _HalaqasTabState extends State<HalaqasTab> {
  ...
  void _showHalaqaOptions(BuildContext context, int halaqaId, String halaqaName) {
            ...
            onTap: () {
              ...
              showDialog(
                ...
                builder: (dialogCtx) => AlertDialog(
                  ...
                  content: Text('هل أنت متأكد من رغبتك في حذف حلقة "$halaqaName"؟'),
                  actions: [
                    TextButton(
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        context.read<HalaqasBloc>().add(DeleteHalaqa(halaqaId));
