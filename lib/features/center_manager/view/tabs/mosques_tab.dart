...
// // import 'package:flutter_admain_center/features/center_manager/view/edit_mosque_screen.dart'; // ستحتاجها لاحقاً
...
//   void initState() {
//     super.initState();
//     // جلب البيانات عند فتح التاب لأول مرة
...
//             onTap: () async {
//               Navigator.pop(ctx);
//               // الانتقال لشاشة التعديل (ستنشئها لاحقاً)
//               // final result = await Navigator.of(context).push<bool>(
//               //   MaterialPageRoute(builder: (_) => EditMosqueScreen(mosque: mosque)),
//               // );
//               // if (result == true) {
//               //   context.read<MosquesBloc>().add(const FetchMosques());
//               // }
...
//                   content: Text('هل أنت متأكد من رغبتك في حذف مسجد "${mosque.name}"؟ سيتم حذف جميع الحلقات والطلاب المرتبطين به.'),
//                   actions: [
...
//     return Scaffold(
//       // ✅ زر عائم لإضافة مسجد جديد
//       floatingActionButton: FloatingActionButton(
//         onPressed: () async {
//           final result = await Navigator.of(context).push<bool>(
//             MaterialPageRoute(builder: (_) => const AddMosqueScreen()),
//           );
//           // إذا عادت الشاشة بنتيجة 'true'، قم بتحديث القائمة
...
//                         return const Center(child: Text('لا يوجد مساجد لعرضها.'));
//                       }
...
//                           return ListItemTile(
//                             title: mosque.name,
//                             // ✅ عرض العنوان وعدد الحلقات
//                             subtitle: 'العنوان: ${mosque.address}\nعدد الحلقات: ${mosque.halaqaCount}',
//                             //isThreeLine: true, // للسماح بعرض سطرين في الـ subtitle
