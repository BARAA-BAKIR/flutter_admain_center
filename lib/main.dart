...
// // /// ويدجت لتوفير كل الخدمات والـ Repositories والبلوكات العامة
...
// //           create: (context) => SuperAdminRepositoryImpl(
...
// //             ),
// //           ),
// //           // توفير AuthBloc فقط لأنه عام على مستوى التطبيق
...
// // /// الويدجت الرئيسي الذي يبني واجهة المستخدم
...
// //           }
// //           // في كل الحالات الأخرى (غير مسجل، أو جاري التحقق)، اعرض الشاشة الترحيبية
...
// //             (context) => const ProgressStagesScreen(),
...
//         useMaterial3: true,
//       ),
//       home: widget.authState is AuthAuthenticated ? 
//       const RoleRouterScreen() : const WelcomeScreen(),
//       routes: {
//         AppRoutes.welcome: (context) => const WelcomeScreen(),
//         AppRoutes.login: (context) => const LoginScreen(),
//         AppRoutes.register: (context) => const RegistrationScreen(),
